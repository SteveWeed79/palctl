...
<!-- `pytest` + `ruff check palctl tests` should be green. If you touched the
daemon's service control, downloads, or the GUI — the parts CI can't reach —
say what you exercised by hand on Windows. -->
